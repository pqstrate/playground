...
# # NUM_THREADS=16 HASH_TYPE=keccak cargo run --release --bin p3_monty_demo > 16_thread_p3_monty_keccak.log
...
# RUSTFLAGS="-C target-feature=+avx512f" NUM_THREADS=1 HASH_TYPE=keccak cargo run --release --bin p3_demo > 1_thread_p3_blake3_avx512.log
# NUM_THREADS=1 HASH_TYPE=keccak cargo run --release --bin p3_demo > 1_thread_p3_blake3.log

# RUSTFLAGS="-C target-feature=+avx512f" NUM_THREADS=2 HASH_TYPE=keccak cargo run --release --bin p3_demo > 2_thread_p3_blake3_avx512.log
# NUM_THREADS=2 HASH_TYPE=keccak cargo run --release --bin p3_demo > 2_thread_p3_blake3.log

# RUSTFLAGS="-C target-feature=+avx512f" NUM_THREADS=4 HASH_TYPE=keccak cargo run --release --bin p3_demo > 4_thread_p3_blake3_avx512.log
# NUM_THREADS=4 HASH_TYPE=keccak cargo run --release --bin p3_demo > 4_thread_p3_blake3.log

# RUSTFLAGS="-C target-feature=+avx512f" NUM_THREADS=8 HASH_TYPE=keccak cargo run --release --bin p3_demo > 8_thread_p3_blake3_avx512.log
# NUM_THREADS=8 HASH_TYPE=keccak cargo run --release --bin p3_demo > 8_thread_p3_blake3.log

# RUSTFLAGS="-C target-feature=+avx512f" NUM_THREADS=16 HASH_TYPE=keccak cargo run --release --bin p3_demo > 16_thread_p3_blake3_avx512.log
# NUM_THREADS=16 HASH_TYPE=keccak cargo run --release --bin p3_demo > 16_thread_p3_blake3.log
...
# NUM_THREADS=16 HASH_TYPE=rpo cargo run --release --bin wf_demo > 16_thread_wf_rpo.log
# NUM_THREADS=8 HASH_TYPE=rpo cargo run --release --bin wf_demo > 8_thread_wf_rpo.log
# NUM_THREADS=4 HASH_TYPE=rpo cargo run --release --bin wf_demo > 4_thread_wf_rpo.log
# NUM_THREADS=2 HASH_TYPE=rpo cargo run --release --bin wf_demo > 2_thread_wf_rpo.log
# NUM_THREADS=1 HASH_TYPE=rpo cargo run --release --bin wf_demo > 1_thread_wf_rpo.log